...
| newRelicClusterName     | string                 | False     | Name for the cluster in the New Relic UI.  Defaults to EKS cluster name if no name is provided.                                                                                                                                                                                                                                                                                                                                                          |
